...
{
    glm::vec3 lightColor = glm::vec3 (0.45, 0.45, 0.45); // mz: reduce light souce brightness
	...
	glm::vec3 colorSum = ambientTerm * color_ +
        lDotn * color_ * lightColor +
        specularTerm * glm::vec3(1) * lightColor; // mz: for double light sources    
	return colorSum;
}
